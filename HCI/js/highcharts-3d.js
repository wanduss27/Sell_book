    ...
    function (b, l) {
        ...
        attr: function (a, e, f, d) {
          ...
          return a.shapeArgs || q(a.x)
            ? this.singleSetterForParts(
                "d",
                null,
                this.renderer[this.pathType + "Path"](a.shapeArgs || a)
              )
      ...
      b.SVGRenderer.prototype.arc3d = function (e) {
        function m(a) {
          ...
          a = k(a);
          for (c in a)
            -1 !== t.indexOf(c) && ((e[c] = a[c]), delete a[c], (f = !0));
          return f ? e : !1;
        }
        var f = this.g(),
          n = f.renderer,
      ...
      x(v, "afterInit", function () {
        ...
        this.is3d() &&
          (b.series || []).forEach(function (p) {
            "scatter" ===
              (p.type || b.chart.type || b.chart.defaultSeriesType) &&
              (p.type = "scatter3d");
          });
      });
  ...
  A(
    ...
    function (b, l) {
      ...
      l(h.prototype, "getPlotLinePath", function (a) {
        ...
        if (!this.chart.is3d() || "colorAxis" === this.coll || null === c)
          return c;
        var d = this.chart,
      ...
      l(h.prototype, "getSlotWidth", function (c, d) {
        if (
          ...
          0 !== f &&
            l &&
            l.label.xy &&
            (k = a({ x: l.label.xy.x, y: l.label.xy.y, z: null }, b, b.vd));
          e &&
            e.label.xy &&
            (p = a({ x: e.label.xy.x, y: e.label.xy.y, z: null }, b, b.vd));
        ...
        b.data.forEach(function (d) {
          ...
          if (null !== d.y) {
            ...
            [
              ...
              if (
                0 !== e[a[1]] &&
                (e[a[0]] >= b[a[0] + "Axis"].len || e[a[0]] + e[a[1]] <= c)
              ) {
            ...
            (a
              ...
              : (k.data.forEach(function (a) {
                  null !== a.y &&
                    ...
                    a.graphic &&
                      a.graphic.animate(a.shapeArgs, k.options.animation));
                }),
                this.drawDataLabels(),
                (k.animate = null)));
        ...
        d.chart.is3d() &&
          d.data.forEach(function (b) {
            k = (b.visible =
              b.options.visible =
              a =
                "undefined" === typeof a ? !x(d.visible, b.visible) : a)
              ? "visible"
              : "hidden";
