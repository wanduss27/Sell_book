                  ...
                  tooltip: {
                    ...
                    custom: function (t) {
                      ...
                      s &&
                        ...
                        ((o = s),
                        (l = n),
                        r.config.series[i].data[a].x &&
                          (h = r.config.series[i].data[a].x));
                      var c = "",
                        d = "",
              ...
              if (o.globals.dataChanged)
                if (this.dynamicAnim) {
                  ...
                  for (var T = 0; T < o.globals.collapsedSeries.length; T++)
                    o.globals.collapsedSeries[T].index === s &&
                      ((z = 1), (a = 0));
                  0 === t && 0 === e && (a = 0),
                    h.animateCircle(
                      v,
            ...
            value: function (t) {
              ...
              if (
                ...
                if (
                  ...
                  if (
                    (b.attr({ class: "apexcharts-datalabel", cx: a, cy: s }),
          ...
          },
          {
            ...
            value: function (t) {
              var e = t.x,
                ...
                f = this.w,
                x = new p(this.ctx),
                b = Array.isArray(this.strokeWidth)
                  ? this.strokeWidth[o]
                  : this.strokeWidth,
                m = e + parseFloat(c * u),
                v = i + parseFloat(h * u);
              f.globals.isXNumeric &&
                ...
                ((m = e + parseFloat(c * (u + 1))),
                (v = i + parseFloat(h * (u + 1)) - b));
              var y = e,
                w = i,
                k = {},
            ...
            value: function (t) {
              ...
              if (c.enabled && !m) {
                ...
                d.config.chart.stacked &&
                  this.barOptions.dataLabels.hideOverflowingLabels &&
                  (this.isHorizontal
                    ? (((h = this.series[s][n] / this.yRatio[this.yaxisIndex]) >
                        0 &&
                        o.width / 1.6 > h) ||
                        (h < 0 && o.width / 1.6 < h)) &&
                      (v = "")
            ...
            value: function (t, e, i) {
              ...
              for (
                ...
                var S = [],
                  ...
                  E = T;
                T > a.globals.gridHeight && (E = a.globals.gridHeight),
                  (m = k / 2);
          ...
          },
          {
            ...
            value: function (t) {
              ...
              "candlestick" === s.chart.type
                ...
                : n.isRangeData &&
                  ((h = n.seriesRangeStart), (c = n.seriesRangeEnd));
              for (var d = t; d < a; d++) {
              ...
              if (!t.globals.isBarHorizontal || this.isTimelineBar) {
                if (
                  ...
                  if (
                    ...
                    t.globals.invertedTimelineLabels.length
                  )
                    for (var u = 0; u < r; u++) {
                      if (
                      ...
                      (u === r - 1 && t.globals.skipLastTimelinelabel) ||
                        f.drawXaxisTicks(c, a);
                    }
                  else
                ...
                if (t.config.grid.yaxis.lines.show) {
                  ...
                  for (var S = 0; S < A; S++) {
                    ...
                    s.add(C),
                      ...
                      (w = y +=
                        t.globals.gridHeight / (this.isTimelineBar ? A : o));
                  }
                }
              } else {
                if (
                  ...
                  for (
                    var L,
                      P = t.globals.padHorizontal,
                      z = t.globals.gridHeight,
                      T = 0;
                    T < r + 1 &&
                    ((L = P = P + t.globals.gridWidth / r + 0.3), T !== r - 1);
                    T++
                  ) {
                    if (t.config.grid.xaxis.lines.show) {
                      var E = e.drawLine(
