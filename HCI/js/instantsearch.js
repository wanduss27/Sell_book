...
!(function (e, t) {
  ...
  var d = function (e) {
    ...
    v = {
      ...
      toggleRefinement: function (e, t, n) {
        ...
        return v.isRefined(e, t, n)
          ? v.removeRefinement(e, t, n)
          : v.addRefinement(e, t, n);
      },
      ...
      e.forEach(function (e) {
        ...
        Object.keys(s).forEach(function (t) {
          ...
          if (o) {
            ...
            if (-1 === r) return;
            f.hierarchicalFacets[n][r].data = p(
              {},
  ...
  ((W.EventEmitter = W).prototype._events = void 0),
    ...
    (W.prototype.emit = function (e) {
      ...
      if (
        ...
        "error" === e &&
          (!this._events.error ||
            (z(this._events.error) && !this._events.error.length)))
      ) {
      ...
      function (e, t) {
        ...
        return (
          ...
          z(this._events[e]) &&
            ...
            (n = K(this._maxListeners)
              ? W.defaultMaxListeners
              : this._maxListeners) &&
            0 < n &&
  ...
  var X = Y,
    G = {
      _getQueries: function (i, a) {
        ...
        return (
          ...
          a.getRefinedDisjunctiveFacets().forEach(function (e) {
            s.push({
              indexName: i,
              params: G._getDisjunctiveFacetSearchParams(a, e),
            });
          }),
      ...
      _getDisjunctiveFacetSearchParams: function (e, t, n) {
        ...
        return (
          (a.facets = s
            ? G._getDisjunctiveHierarchicalFacetAttribute(e, s, n)
            : t),
      ...
      !(function (R) {
        ...
        (R.tags = {
          ...
          (R.scan = function (e, t) {
            ...
            function y() {
              0 < h.length &&
                (f.push({ tag: "_t", text: new String(h) }), (h = ""));
            }
            function b(e, t) {
              if (
                (y(),
                    ...
                    for (var e = !0, t = p; t < f.length; t++)
                      if (
                        !(e =
                          ...
                          ("_t" == f[t].tag && null === f[t].text.match(w)))
                      )
                        return !1;
                    return e;
                  })())
  ...
  function Te(e, t) {
    if (e === t) return !0;
    if (Le(e) || Le(t) || "function" == typeof e || "function" == typeof t)
      return e === t;
        ...
        return (function (e, t) {
          ...
          (function (e, t) {
            ...
            (function (e, t) {
              ...
              return 0 < n.length
                ? e.setQueryParameters({ ruleContexts: n })
                : e;
            })(
              (function (e, t) {
  ...
  function Ke(e) {
    ...
    return {
      ...
      addWidgets: function (e) {
        ...
        if (!Array.isArray(e))
          throw new Error(
            Ue("The `addWidgets` method expects an array of widgets.")
          );
        if (
          e.some(function (e) {
        ...
        return (
          ...
          f &&
            Boolean(e.length) &&
            (m.setState(
              $e(l, { uiState: h, initialSearchParameters: m.state })
            ),
            e.forEach(function (e) {
              f &&
                e.init &&
      ...
      removeWidgets: function (t) {
        if (!Array.isArray(t))
          throw new Error(
            Ue("The `removeWidgets` method expects an array of widgets.")
          );
        if (
          t.some(function (e) {
          ...
          throw new Error(
            Ue("The widget definition expects a `dispose` method.")
          );
        if (
          ...
          return {
            ...
            allowPrototypes:
              "boolean" == typeof e.allowPrototypes
                ...
                : Lt.allowPrototypes,
            arrayLimit:
              "number" == typeof e.arrayLimit ? e.arrayLimit : Lt.arrayLimit,
            charset: t,
            charsetSentinel:
                      ...
                      if (n !== o) {
                        ...
                        (l =
                          -1 === d
                            ...
                            : ((u = t.decoder(h.slice(0, d), Lt.decoder, c)),
                              t.decoder(h.slice(d + 1), Lt.decoder, c))) &&
        ...
        var n,
          ...
          i = (function (e) {
            ...
            var r = St.formatters[n],
              i = It.filter;
            return (
              ("function" != typeof e.filter && !xt(e.filter)) ||
                (i = e.filter),
              {
                addQueryPrefix:
                  "boolean" == typeof e.addQueryPrefix
                    ...
                    : It.addQueryPrefix,
                allowDots:
                  void 0 === e.allowDots ? It.allowDots : !!e.allowDots,
                charset: t,
                charsetSentinel:
                  "boolean" == typeof e.charsetSentinel
                    ? e.charsetSentinel
                ...
                encoder:
                  "function" == typeof e.encoder ? e.encoder : It.encoder,
                encodeValuesOnly:
  ...
  var At = (function () {
      function v(e) {
        ...
        if (null === d)
          throw new Error(Et("The `searchClient` option is required."));
        ...
        if (
          ...
          throw new Error(
            Et("The `insightsClient` option should be a function.")
          );
        if (
          ((n.client = d),
          (n.insightsClient = p),
                        ...
                        !(function t(e, n) {
                          ...
                          var t = e.getWidgets(),
                            ...
                            r = t.reduce(function (e, t) {
                              return t.getWidgetSearchParameters
                                ? t.getWidgetSearchParameters(e, { uiState: n })
                                : e;
                            }, e.getHelper().state);
                          e
                            .getHelper()
                            .overrideStateWithoutTriggeringChangeEvent(r),
                            a.scheduleSearch();
                        });
                      });
                    },
    ...
    return (
      ...
      function () {
        ...
        if (!c || !Array.isArray(c) || 0 === c.length)
          throw new Error(
            $t("The `attributes` option expects an array of strings.")
          );
        if (!0 === m && p <= d)
          throw new Error(
            $t("The `showMoreLimit` option must be greater than `limit`.")
          );
        var y = B(c, 1)[0];
        return {
          ...
          getWidgetState: function (e, t) {
            ...
            return n.length
              ? D({}, e, {
                  hierarchicalMenu: D({}, e.hierarchicalMenu, C({}, y, n)),
                })
              : e;
          },
  ...
  function bn(e, t, n) {
    if ((null == n && (n = []), null == e || "boolean" == typeof e))
      ...
      for (var r = 0; r < e.length; r++) bn(e[r], t, n);
    else
      n.push(
        t
          ? t(
          ...
          return (
            null === t.type
              ...
              : t !== n &&
                ...
                h ||
                  yn(e, t, n, r, "foreignObject" !== t.type && i, a, s, an, o),
                o ||
                  ("value" in d &&
                    void 0 !== d.value &&
                    d.value !== e.value &&
  ...
  (Zt = {}),
    (dn.prototype.setState = function (e, t) {
      ...
      ("function" == typeof e && !(e = e(n, this.props))) || cn(n, e),
        null != e &&
          this.__v &&
          ((this.u = !1), t && this.__h.push(t), gn(this));
    }),
  ...
  function Tn(c) {
    ...
    return (
      ...
      function () {
        ...
        if (!Array.isArray(o))
          throw new Error(
            Ln("The `items` option expects an array of objects.")
          );
        ...
        if (1 < n.length)
          throw new Error(
            Ln("More than one default value is specified in `items`.")
          );
        var r = n[0];
        return {
          ...
          getWidgetSearchParameters: function (e, t) {
            var n = t.uiState;
            return e.setQueryParameters({
              hitsPerPage: n.hitsPerPage || r.value,
            });
          },
        };
      }
        ...
        return {
          ...
          render: function (e) {
            ...
            (s.facetsRefinements = h(s.facetsRefinements)),
              (s.hierarchicalFacetsRefinements = h(
                s.hierarchicalFacetsRefinements
              )),
              (s.disjunctiveFacetsRefinements = h(
  ...
  function An(d) {
    ...
    return (
      ...
      function () {
        ...
        if (!0 === l && h <= u)
          throw new Error(
            On("The `showMoreLimit` option must be greater than `limit`.")
          );
        return {
          $$type: "ais.menu",
          isShowingMore: !1,
        ...
        var e = i || {},
          ...
          s =
            void 0 === a
              ...
              : a;
        if ("" === u)
          throw new Error(Dn("The `attribute` option is required."));
        if (!r || 0 === r.length)
          throw new Error(
            Dn("The `items` option expects an array of objects.")
          );
        function o(i) {
  ...
  function Jn(x) {
    ...
    return (
      ...
      function () {
        ...
        if (!0 === g && f <= p)
          throw new Error(
            Kn("`showMoreLimit` should be greater than `limit`.")
          );
        function y(e) {
          var t = e.name;
              ...
              if ("" === e && P)
                ...
                n.searchForFacetValues(m, e, b(c), t).then(function (e) {
                  var t = l
                      ? (function (e) {
                          return e.map(function (e) {
                            return D({}, e, { highlighted: Xe(e.highlighted) });
                          });
                        })(e.facetHits)
                      : e.facetHits,
                    n = v(
                      t.map(function (e) {
                        var t = e.value;
                        return D({}, O(e, ["value"]), { value: t, label: t });
                      })
                    );
                  R({
                    items: n,
        ...
        return {
          ...
          getWidgetState: function (e, t) {
            ...
            return r.length
              ? D({}, e, {
                  refinementList: D({}, e.refinementList, C({}, m, r)),
                })
              : e;
          },
          getWidgetSearchParameters: function (e, t) {
  ...
  function Zn(c) {
    ...
    return (
      ...
      function () {
        ...
        if (!Array.isArray(s))
          throw new Error(
            Gn("The `items` option expects an array of objects.")
          );
        return {
          $$type: "ais.sortBy",
          init: function (e) {
      ...
      function () {
        ...
        return {
          ...
          render: function (e) {
            ...
            for (
              var c = this._getRefinedStar(t.state), u = p - 1;
              1 <= u;
              --u
            ) {
              var l = s[u];
    ...
    return (
      ...
      function () {
        ...
        if (!t || !Array.isArray(t) || 0 === t.length)
          throw new Error(
            sr("The `attributes` option expects an array of strings.")
          );
        var s = B(t, 1)[0];
        return {
          $$type: "ais.breadcrumb",
      ...
      return {
        ...
        init: function (e) {
          ...
          (r.refine = (function (r) {
            ...
            a(
              { refine: r.refine, instantSearchInstance: t, widgetParams: i },
              !0
            );
        },
        render: function (e) {
        ...
        getWidgetState: function (e) {
          return D({}, e, {
            configure: D({}, e.configure, {}, i.searchParameters),
          });
        },
      };
    };
  ...
  function vr(c, u) {
    return function (e) {
      ...
      return D({}, mr(c, u)({ searchParameters: o }), {
          ...
          ln(
            ...
            a || !o
              ? ln(
                  ...
                  ln(
                    jr,
                    f({}, h, { templateKey: "toggle", rootTagName: "span" })
                  )
                )
              : ln(
                  Qr,
  ...
  var Zr = (function () {
    function i() {
      ...
      return (
        C(
          y((s = A(this, (e = E(i)).call.apply(e, [this].concat(n))))),
          "state",
          { query: s.props.query, focused: !1 }
        ),
  ...
  var ei = (function () {
    function c(e) {
      ...
      return (
        T(this, c),
        ((t = A(this, E(c).call(this, e))).handleItemClick =
          t.handleItemClick.bind(y(t))),
        t
      );
    }
    return (
            ...
            var t = this,
              e = kr(
                ...
                C(
                  {},
                  ""
                    .concat(this.props.cssClasses.depth)
                    .concat(this.props.depth),
          ...
          },
          {
            ...
            value: function (e) {
              var t = e.min,
                ...
                r = e.step;
              if (r)
                return [].concat(w(Me({ start: t, end: n, step: r })), [n]);
            },
          },
          {
            key: "render",
      ...
      ln(
        ...
        r.map(function (t, e) {
          ...
          return ln(
            ...
            {
              key: t.label + e,
              className: kr(i.item, C({}, i.selectedItem, n)),
            },
            ln(
              jr,
              f({}, a, {
  ...
  var ns = Ae({ name: "panel" }),
    ...
    ls = Object.freeze({
      ...
      currentRefinements: function (e) {
        ...
        var o = ue(t),
          c = {
            ...
            categoryLabel: kr(
              Ur({ descendantName: "categoryLabel" }),
              a.categoryLabel
            ),
      ...
      geoSearch: function (e) {
        ...
        if (!R)
          throw new Error(Yr("The `googleReference` option is required."));
        var _ = ue(b),
          x = {
            root: kr(Xr(), u.root),
      ...
      infiniteHits: function (e) {
        ...
        var l = ue(n),
          h = {
            ...
            loadPrevious: kr(
              mi({ descendantName: "loadPrevious" }),
              c.loadPrevious
            ),
      ...
      stats: function () {
        ...
        var s = ue(t),
          o = {
            root: kr(pa(), r.root),
            text: kr(pa({ descendantName: "text" }), r.text),
          };
        return rr(
          (function (e) {
      ...
      panel: function (e) {
        var t = 0 < arguments.length && void 0 !== e ? e : {},
          ...
          f = {
            ...
            collapsibleRoot: kr(
              rs({ modifierName: "collapsible" }),
              c.collapsibleRoot
            ),
            collapsedRoot: kr(
              rs({ modifierName: "collapsed" }),
              c.collapsedRoot
            ),
            collapseButton: kr(
            ...
            collapseIcon: kr(
              rs({ descendantName: "collapseIcon" }),
              c.collapseIcon
            ),
