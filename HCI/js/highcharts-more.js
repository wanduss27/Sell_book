...
(function (t) {
      ...
      g(r.prototype, {
        ...
        render: function () {
          ...
          if (e)
            for (
              e = m(e),
                a = Math.max(e.length, this.background.length || 0),
                l = 0;
              l < a;
              l++
            )
              e[l] && this.axis
                ? this.renderBackground(
                    w(this.defaultBackgroundOptions, e[l]),
                    l
                  )
                : this.background[l] &&
                  ((this.background[l] = this.background[l].destroy()),
                  this.background.splice(l, 1));
        },
    ...
    function (b, a) {
      ...
      var p = {
        ...
        setAxisSize: function () {
          ...
          this.isRadial &&
            ...
            (this.len =
              this.width =
              this.height =
                (this.center[2] * k(this.sector, 1)) / 2));
        },
        getPosition: function (c, f) {
          c = this.translate(c);
          return this.postTranslate(
            this.isCircular ? c : this.angleRad,
            k(this.isCircular ? f : 0 > c ? 0 : c, this.center[2] / 2) -
              this.offset
          );
        },
        postTranslate: function (c, f) {
          ...
          return {
            x: q.plotLeft + p[0] + Math.cos(c) * f,
            y: q.plotTop + p[1] + Math.sin(c) * f,
          };
        },
        getPlotBandPath: function (c, f, q) {
          ...
          if ("polygon" === this.options.gridLineInterpolation)
            ...
            if ("circle" !== q.shape && e)
              (c = d + this.translate(c)), (f = d + this.translate(f));
            else {
              c = -Math.PI / 2;
              f = 1.5 * Math.PI;
              var g = !0;
            ...
            v[0] -= a;
            v[2] -= a;
            v = this.chart.renderer.symbols.arc(
              this.left + p[0],
              this.top + p[1],
              v[0],
              v[0],
            ...
            e &&
              ...
              (v.xBounds =
                e > -Math.PI / 2 && e < Math.PI / 2
                  ? [a, this.chart.plotWidth]
                  : [0, a]),
              (v.yBounds = [this.top + p[1] + (p[2] / 2) * Math.sin(e)]),
              (v.yBounds[0] +=
                (e > -Math.PI && 0 > e) || e > Math.PI ? -10 : 10));
          }
          return v;
        },
        getCrosshairPosition: function (c, f, q) {
          ...
          if (this.isCircular) {
            if (g(p))
              ...
              var a = c.chartY || 0;
              p = this.translate(
                Math.atan2(a - q, d - f) - this.startAngleRad,
                !0
              );
            }
            ...
            g(p) || ((d = c.chartX), (a = c.chartY)),
              g(d) &&
                ...
                (p = this.translate(
                  Math.min(
                    Math.sqrt(Math.pow(d - f, 2) + Math.pow(a - q, 2)),
                    this.len
                  ),
                  !0
                ));
        ...
        getPlotLinePath: function (c) {
          ...
          var u, m;
          c.isCrosshair &&
            ((h = this.getCrosshairPosition(c, n, q)),
            (a = h[0]),
            (b = h[1]),
            (h = h[2]));
          if (f.isCircular) {
        ...
        getTitlePosition: function () {
          ...
          return {
            ...
            y:
              f.plotTop +
              c[1] -
              { high: 0.5, middle: 0.25, low: 0 }[q.align] * c[2] +
              (q.y || 0),
          };
        },
        createLabelCollector: function () {
          ...
          return function () {
            if (
              c.isRadial &&
              c.tickPositions &&
              !0 !== c.options.labels.allowOverlap
            )
      ...
      e(l, "afterInit", function () {
        ...
        (c.angular && this.isXAxis) ||
          ...
          (this.endAngleRad =
            ((k(p.endAngle, p.startAngle + 360) - 90) * Math.PI) / 180),
      ...
      e(d, "afterGetLabelPosition", function (c) {
        var f = this.axis,
          ...
          n = d.align,
          e =
            (((f.translate(this.pos) + f.startAngleRad + Math.PI / 2) /
              Math.PI) *
              180) %
            360,
          l = Math.round(e),
        ...
        if (f.isRadial) {
          var x = f.getPosition(
            this.pos,
            f.center[2] / 2 +
              z(k(d.distance, -25), f.center[2] / 2, -f.center[2] / 2)
          );
          "auto" === d.rotation
            ? q.attr({ rotation: e })
            : null === a &&
              (a =
                f.chart.renderer.fontMetrics(q.styles && q.styles.fontSize).b -
                p.height / 2);
          null === n &&
            (f.isCircular
              ? (p.width > (f.len * f.tickInterval) / (f.max - f.min) &&
                  (h = 0),
                (n =
                  e > h && e < 180 - h
                    ? "left"
          ...
          if ("auto" === n && 2 === f.tickPositions.length && f.isCircular) {
            ...
            15 > b || (180 <= b && 195 > b)
              ...
              : 215 < b &&
                270 >= b &&
                (m = "start" === g ? p.height : 0.25 * -p.height);
            15 > u
      ...
      a(x, "getMarkPath", function (c, f, q, p, d, a, h) {
        var n = this.axis;
        n.isRadial
          ? ((c = n.getPosition(this.pos, n.center[2] / 2 + p)),
            (f = ["M", f, q, "L", c.x, c.y]))
      ...
      a(
        ...
        },
        {
          ...
          translate: function () {
            ...
            a.points.forEach(function (e) {
              ...
              e.isNull
                ? (e.plotY = null)
                : ((e.plotLow = n),
                  (e.plotHigh = h.translate(
                    d ? a.modifyValue(b, e) : b,
                    0,
                    1,
                    0,
                    1
          ...
          drawDataLabels: function () {
            ...
            if (c.enabled)
              for (d = h; d--; )
                if ((n = a[d]))
                  n.dataLabels = [n.dataLabelUpper, n.dataLabel].filter(
                    function (f) {
                      return !!f;
                    }
                  );
        ...
        },
        {
          ...
          haloPath: function () {
            ...
            this.isTopInside &&
              (e = e.concat(l.haloPath.apply(this, arguments)));
            return e;
          },
  ...
  A(
    t,
    "parts-more/AreaSplineRangeSeries.js",
    [t["parts/Globals.js"]],
    function (b) {
      var a = b.seriesType;
            ...
            a.points.forEach(function (c) {
              ...
              k
                ? ((d = c.barX + h),
                  (c.shapeType = "path"),
                  (c.shapeArgs = {
                    d: a.polarArc(e + C, e, d, d + c.pointWidth),
                  }))
                : ((f.height = C),
                  (f.y = e),
                  (c.tooltipPos = m.inverted
                    ...
                    : [
                        b.left - m.plotLeft + f.x + f.width / 2,
                        l.pos - m.plotTop + e + C / 2,
                        C,
                      ]));
            });
          },
          ...
          translate: function () {
            ...
            this.points.forEach(function (g) {
              b.forEach(function (e) {
                null !== g[e] &&
                  (g[e + "Plot"] = a.translate(g[e], 0, 1, 0, 1));
              });
            });
          },
          drawPoints: function () {
            ...
            for (a = g.length; l < a; l++) {
              ...
              if (d) {
                if (b) {
                  ...
                  m.isSum ||
                    (k.connectorThreshold = k.threshold + k.stackTotal);
                  p.reversed
                    ? ((r = 0 <= u ? w - u : w + u), (u = w))
                    : ((r = w), (u = w - u));
                  m.below = r <= t(e, 0);
                ...
                (w = Math.max(h, h + u) + k[0]),
                  ...
                  m.isSum
                    ? ((y.y = p.translate(k[1], 0, 1, 0, 1)),
                      (y.height =
                        Math.min(p.translate(k[0], 0, 1, 0, 1), p.len) - y.y))
                    : m.isIntermediateSum
                    ? (0 <= u
                        ? ((r = k[1] + c), (u = c))
                        : ((r = c), (u = k[1] + c)),
                      ...
                      (y.y = p.translate(r, 0, 1, 0, 1)),
                      (y.height = Math.abs(
                        y.y - Math.min(p.translate(u, 0, 1, 0, 1), p.len)
                      )),
                      (c += k[1]))
                    : ((y.height =
                        0 < r
                          ? p.translate(h, 0, 1, 0, 1) - y.y
                          : p.translate(h, 0, 1, 0, 1) -
                            p.translate(h - r, 0, 1, 0, 1)),
                      (h += r),
                      (m.below = h < t(e, 0))),
              ...
              if (k) {
                ...
                b
                  ? ((k = k.connectorThreshold),
                    (u =
                      Math.round(p.translate(k, 0, 1, 0, 1) + (d ? u : 0)) - f))
  ...
  A(t, "parts-more/PolygonSeries.js", [t["parts/Globals.js"]], function (b) {
    ...
    r(
      ...
      },
      {
        ...
        getGraphPath: function () {
          for (
            var b = a.prototype.getGraphPath.call(this), g = b.length + 1;
            g--;
    ...
    function (b, a) {
      ...
      b.BubbleLegend.prototype = {
        ...
        drawLegendSymbol: function (a) {
          ...
          this.fontMetrics = c.renderer.fontMetrics(
            f.labels.style.fontSize.toString() + "px"
          );
        ...
        renderRange: function (a) {
          ...
          a = e
            ...
            .attr(k ? {} : a.labelStyle)
            .addClass(
              "highcharts-bubble-legend-labels " + (c.labels.className || "")
            )
            .add(this.legendSymbol);
          p.push(a);
          a.placed = !0;
      ...
      u(b.Legend, "afterGetAllItems", function (a) {
        ...
        c &&
          c.ranges &&
          c.ranges.length &&
          (e.ranges.length && (e.autoRanges = !!e.ranges[0].autoRanges),
          this.destroyItem(c));
        0 <= d &&
          f.enabled &&
          e.enabled &&
      ...
      l.prototype.getVisibleBubbleSeriesIndex = function () {
        for (var a = this.series, c = 0; c < a.length; ) {
          if (a[c] && a[c].isBubble && a[c].visible && a[c].zData.length)
            return c;
          c++;
        }
        return -1;
      ...
      e.prototype.retranslateItems = function (a) {
        ...
        this.allItems.forEach(function (q, h) {
          ...
          if ((e = q.movementX) || (d && q.ranges))
            (e = d ? c - q.options.maxSize / 2 : c + e),
              q.legendGroup.attr({ translateX: e });
          h > a[b].step && b++;
      ...
      u(t, "legendItemClick", function () {
        ...
        f &&
          ...
          f.bubbleLegend.visible !== a &&
            (f.update({ bubbleLegend: { enabled: a } }),
            (f.bubbleLegend.visible = a)),
          (this.visible = c));
      });
      a(l.prototype, "drawChartBox", function (a, c, f) {
        ...
        if (
          ...
          e.options.enabled &&
          e.bubbleLegend &&
          e.options.bubbleLegend.autoRanges &&
          d
        ) {
      ...
      a.prototype.beforePadding = function () {
        ...
        D.length &&
          ...
          [
            ...
            "undefined" === typeof t(a.options[f[0]], a[f[1]]) &&
              (a[f[0]] += f[2] / y);
          }));
      };
      ("");
  ...
  A(
    t,
    "modules/networkgraph/integrations.js",
    [t["parts/Globals.js"]],
    function (b) {
      b.networkgraphIntegrations = {
        ...
        euler: {
          ...
          integrate: function (a, b) {
            ...
            0 !== g &&
              ((b.plotX +=
                (b.dispX / g) * Math.min(Math.abs(b.dispX), a.temperature)),
              (b.plotY +=
                (b.dispY / g) * Math.min(Math.abs(b.dispY), a.temperature)));
          },
          getK: function (a) {
    ...
    function (b, a) {
      ...
      m(b.layouts["reingold-fruchterman"].prototype, {
        init: function (a) {
          ...
          this.attractiveForce = k(
            a.attractiveForce,
            this.integration.attractiveForceFunction
          );
          this.repulsiveForce = k(
            a.repulsiveForce,
        ...
        setCircularPositions: function () {
          function a(b) {
            b.linksFrom.forEach(function (b) {
              x[b.toNode.id] ||
                ((x[b.toNode.id] = !0), m.push(b.toNode), a(b.toNode));
            });
          }
          var b = this.box,
            g = this.nodes,
        ...
        barnesHutApproximation: function (a, b) {
          ...
          if (a !== b && 0 !== h)
            if (b.isInternal)
              ...
              (d = this.repulsiveForce(h, this.k)),
                this.force("repulsive", a, d * b.mass, e, h);
          return g;
        },
        ...
        attractiveForces: function () {
          ...
          a.links.forEach(function (d) {
            d.fromNode &&
              ...
              (g = a.vectorLength(b)),
              0 !== g &&
                ((h = a.attractiveForce(g, a.k)),
                a.force("attractive", d, h, b, g)));
          });
        },
  ...
  A(
    t,
    "modules/networkgraph/draggable-nodes.js",
    [t["parts/Globals.js"]],
    function (b) {
      var a = b.Chart,
        r = b.addEvent;
        ...
        barycenter: function () {
          ...
          d.forEach(function (f) {
            a.options.splitSeries && !f.isParentNode
              ? ((e = f.series.parentNode.plotX),
                (h = f.series.parentNode.plotY))
              : ((e = c.width / 2), (h = c.height / 2));
            f.fixedPosition ||
              ((f.plotX -=
                ((f.plotX - e) * b) / (f.mass * Math.sqrt(d.length))),
              (f.plotY -=
                ((f.plotY - h) * b) / (f.mass * Math.sqrt(d.length))));
          });
        },
      ...
      b.layouts.packedbubble = k(n, {
        ...
        setCircularPositions: function () {
          ...
          c.forEach(function (f, c) {
            a.options.splitSeries && !f.isParentNode
              ? ((h = f.series.parentNode.plotX),
                (g = f.series.parentNode.plotY))
          ...
          a.nodes.forEach(function (f) {
            ...
            a.nodes.forEach(function (q) {
              ...
              f === q ||
                ...
                ((d = a.getDistXY(f, q)),
                (c =
                  a.vectorLength(d) - (f.marker.radius + q.marker.radius + e)),
                0 > c &&
                  ((f.degree += 0.01),
                  f.neighbours++,
                  (b = a.repulsiveForce(
                    -c / Math.sqrt(f.neighbours),
                    a.k,
                    f,
                    q
                  ))),
        ...
        applyLimitBox: function (a) {
          if (
            ...
            0 > b &&
              b > -2 * a.marker.radius &&
              ((a.plotX -= 0.01 * f.x), (a.plotY -= 0.01 * f.y));
          }
        ...
        },
        {
          ...
          accumulateAllPoints: function (a) {
            ...
            for (c = 0; c < f.series.length; c++)
              if (
                ((a = f.series[c]),
                a.visible || !f.options.chart.ignoreHiddenSeries)
              )
          ...
          calculateParentRadius: function () {
            ...
            this.parentNodeRadius = r(
              ...
              a
                ? Math.max(
                    Math.sqrt(Math.pow(a.width, 2) + Math.pow(a.height, 2)) /
                      2 +
                      20,
                    20
                  )
          ...
          createParentNodes: function () {
            ...
            d ||
              ...
              a.parentNode &&
                ((e.plotX = a.parentNode.plotX),
                (e.plotY = a.parentNode.plotY)),
              (a.parentNode = e),
          ...
          addLayout: function () {
            ...
            c ||
              ((this.chart.graphLayoutsStorage = c = {}),
              (this.chart.graphLayoutsLookup = d = []));
            var h = c[a.type];
            h ||
              ((a.enableSimulation = g(e.forExport)
                ? !e.forExport
                : a.enableSimulation),
          ...
          translate: function () {
            ...
            if (h) var n = a.allDataPoints;
              ...
              (n = this.placeBubbles(a.allDataPoints)),
          ...
          resizeRadius: function () {
            ...
            if (1e-10 < Math.abs(c - 1)) {
              ...
              (a.diffY = g / 2 + h - p - (l - p) / 2),
                (a.diffX = n / 2 + e - m - (x - m) / 2);
          },
    ...
    function (b, a) {
      ...
      e.searchPointByAngle = function (a) {
        ...
        return this.searchKDTree({
          clientX:
            ...
            (-180 / Math.PI) *
              Math.atan2(
                a.chartX - e[0] - b.plotLeft,
                a.chartY - e[1] - b.plotTop
              ),
        });
      };
      ...
      e.toXY = function (a) {
        ...
        f &&
          c &&
          !c.isRadialBar &&
          (a.plotY = l = "number" === typeof k ? h.translate(k) || 0 : 0);
        a.rectPlotX = g;
        a.rectPlotY = l;
      ...
      z.spline &&
        ...
        z.areasplinerange &&
          (z.areasplinerange.prototype.getPointSpline =
            z.spline.prototype.getPointSpline));
      b.addEvent(
        t,
        "afterTranslate",
        function () {
              ...
              if (g.inverted) {
                ...
                if (h) {
                  if (
                    ...
                    var y =
                      H[I].points[
                        this.getStackIndicator(void 0, I, this.index).key
                      ];
                ...
                d.plotY =
                  (r(this.translatedThreshold) &&
                    (D < this.translatedThreshold ? D : y)) - m;
              } else
                (d.shapeType = "path"),
                  (D = A + m),
                  (d.shapeArgs = {
                    d: this.polarArc(d.yBottom, d.plotY, D, D + d.pointWidth),
                  });
              this.toXY(d);
              g.inverted
                ? ((A = l.postTranslate(
                    d.rectPlotY,
                    d.barX + d.pointWidth / 2
                  )),
              ...
              c.inverted
                ? ((this.forceDL = c.isInsidePlot(
                  ...
                  d && b.shapeArgs
                    ...
                    : b.tooltipPos &&
                      (m = { x: b.tooltipPos[0], y: b.tooltipPos[1] }),
      ...
      b.addEvent(b.Series, "afterInit", function () {
        ...
        a.inverted &&
          ...
          this instanceof z.column && (this.isRadialBar = !0));
      });
