...
(function (S, M) {
  ...
  M(J, "parts/Utilities.js", [J["parts/Globals.js"]], function (c) {
    ...
    function D(d, a, b, l) {
      ...
      var x = (
        Math.abs(g[1] ? g[0] : d) + Math.pow(10, -Math.max(a, k) - 1)
      ).toFixed(a);
      k = String(e(x));
    ...
    c.error = function (d, b, k, l) {
      var h = q(d),
        f = h
          ? "Highcharts error #" + d + ": www.highcharts.com/errors/" + d + "/"
          : d.toString(),
        g = function () {
          if (b) throw Error(f);
      ...
      k
        ? c.fireEvent(k, "displayError", { code: d, message: f, params: l }, g)
        : g();
    };
    c.Fx = function (d, a, b) {
      this.options = a;
    ...
    c.Fx.prototype = {
      ...
      update: function () {
        ...
        if (this[a + "Setter"]) this[a + "Setter"]();
          ...
          d.attr
            ? d.element && d.attr(a, b, null, !0)
            : (d.style[a] = b + this.unit);
        l && l.call(d, b, this);
      },
      run: function (d, b, k) {
        var h = this,
      ...
      initPath: function (d, a, b) {
        function h(d) {
          for (n = d.length; n--; ) {
            ...
            a &&
              b &&
              d.splice(n + 1, 0, d[n + 1], d[n + 2], d[n + 1], d[n + 2]);
          }
        }
        function f(d, a) {
          for (; d.length < r; ) {
            ...
            z &&
              ((b = d.slice(d.length - c)),
              [].splice.apply(d, [d.length, 0].concat(b)),
              n--);
          }
          d[0] = "M";
        }
    ...
    c.getStyle = function (d, b, f) {
      if ("width" === b)
        return (
          ...
          Math.max(
            0,
            b - c.getStyle(d, "padding-left") - c.getStyle(d, "padding-right")
          )
        );
      if ("height" === b)
        return Math.max(
      ...
      if ((d = a.getComputedStyle(d, void 0)))
        (d = d.getPropertyValue(b)), w(f, "opacity" !== b) && (d = e(d));
      return d;
    };
    ...
    c.animate = function (a, b, f) {
      ...
      A(b, function (t, l) {
        ...
        k = null;
        "d" === l
          ? ((g.paths = g.initPath(a, a.d, b.d)),
            (g.toD = b.d),
            (d = 0),
            (k = 1))
          : a.attr
          ? (d = a.attr(l))
          : ((d = parseFloat(c.getStyle(a, l)) || 0),
            "opacity" !== l && (h = "px"));
        k || (k = t);
    ...
    return {
      ...
      pad: function (a, b, f) {
        return (
          Array((b || 2) + 1 - String(a).replace("-", "").length).join(
            f || "0"
          ) + a
        );
      },
  ...
  M(
    ...
    function (c, e) {
      ...
      q(P.prototype, {
        ...
        init: function (a, b) {
          this.element =
            "span" === b ? k(b) : y.createElementNS(this.SVG_NS, b);
          this.renderer = a;
        ...
        complexColor: function (a, b, d) {
          ...
          c.fireEvent(
            ...
            function () {
              a.radialGradient
                ? (Q = "radialGradient")
                : a.linearGradient && (Q = "linearGradient");
              Q &&
                ((g = a[Q]),
                (f = n.gradients),
                (t = a.stops),
        ...
        removeTextOutline: function (a) {
          for (var b = a.length, d; b--; )
            (d = a[b]),
              "highcharts-text-outline" === d.getAttribute("class") &&
                v(a, this.element.removeChild(d));
        },
        symbolCustomAttribs:
        ...
        css: function (a) {
          ...
          if (z) {
            ...
            if (a)
              ...
              else if ("text" === n.nodeName.toLowerCase() && a.width)
                var Q = (this.textWidth = D(a.width));
            this.styles = a;
        ...
        align: function (a, b, d) {
          ...
          if (a) {
            if (
              ((this.alignOptions = a), (this.alignByTranslate = b), !d || w(d))
            )
              (this.alignTo = n = d || "renderer"),
                v(f, this),
                f.push(this),
                (d = null);
          } else
        ...
        getBBox: function (a, b) {
          ...
          var x = n.styledMode
            ? g && P.prototype.getStyle.call(g, "font-size")
            : z && z.fontSize;
          if (G(f)) {
            var c = f.toString();
            ...
            if (Q || n.forExport) {
              try {
                (K =
                  ...
                  function (a) {
                    [].forEach.call(
                      g.querySelectorAll(".highcharts-text-outline"),
                      function (b) {
                        b.style.display = a;
                      }
                    );
              ...
              Q &&
                (d.height = n =
                  { "11px,17": 14, "13px,20": 16 }[
                    z && z.fontSize + "," + Math.round(n)
                  ] || n),
              b &&
                ((z = b * l),
                (d.width =
                  Math.abs(n * Math.sin(z)) + Math.abs(a * Math.cos(z))),
                (d.height =
                  Math.abs(n * Math.cos(z)) + Math.abs(a * Math.sin(z)))));
            if (c && 0 < d.height) {
        ...
        destroy: function () {
          ...
          f &&
            g &&
            ([].forEach.call(
              g.querySelectorAll("[clip-path],[CLIP-PATH]"),
              function (a) {
          ...
          a.safeRemoveChild(b);
          for (
            d.styledMode || a.destroyShadows();
            n && n.div && 0 === n.div.childNodes.length;

          )
            (b = n.parentGroup),
              a.safeRemoveChild(n.div),
              delete n.div,
              (n = b);
        ...
        shadow: function (a, b, d) {
          ...
          if (!a) this.destroyShadows();
            ...
            for (g = 1; g <= f; g++) {
              ...
              d &&
                (I(t, "height", Math.max(I(t, "height") - l, 0)),
                (t.cutHeight = l));
              b
                ? b.element.appendChild(t)
                : z.parentNode && z.parentNode.insertBefore(t, z);
              n.push(t);
            }
            this.shadows = n;
          }
        ...
        fillSetter: function (a, b, d) {
          "string" === typeof a
            ? d.setAttribute(b, a)
            : a && this.complexColor(a, b, d);
        },
        visibilitySetter: function (a, b, d) {
          "inherit" === a
            ? d.removeAttribute(b)
            : this[b] !== a && d.setAttribute(b, a);
          this[b] = a;
        },
      ...
      P.prototype["stroke-widthSetter"] = P.prototype.strokeSetter = function (
        a,
        b,
        d
      ) {
      ...
      q(e.prototype, {
        ...
        init: function (a, b, d, n, z, t, l) {
          ...
          this.createElement("desc")
            .add()
            .element.appendChild(
              y.createTextNode("Created with Highcharts 8.0.0")
            );
        ...
        definition: function (a) {
          function b(a, n) {
            ...
            A(a).forEach(function (a) {
              ...
              z.add(n || d.defs);
              a.textContent &&
                z.element.appendChild(y.createTextNode(a.textContent));
              b(a.children || [], z);
              g = z;
            });
            return g;
            ...
            p = function (z, t) {
              ...
              if ("undefined" === typeof k[t])
                if (b.getSubStringLength)
                  ...
                  h.getSpanWidth &&
                    (N(f(d || n, z)), (k[t] = g + h.getSpanWidth(a, b)));
              return k[t];
            },
            R;
          a.rotation = 0;
        ...
        buildText: function (a) {
          ...
          var V = function (a) {
              ...
              return k
                ? D(k)
                : d.fontMetrics(n, a.getAttribute("style") ? a : b).h;
            },
            q = function (a, b) {
        ...
        arc: function (a, b, d, n, g, z) {
          u(a)
            ? ((n = a), (b = n.y), (d = n.r), (a = n.x))
            : (n = { innerR: n, start: g, end: z });
        ...
        symbol: function (b, d, n, g, z, f) {
          var t = this,
            ...
            N =
              G(d) &&
              K &&
              K.call(this.symbols, Math.round(d), Math.round(n), g, z, f);
          if (K) {
            var p = this.path(N);
        ...
        label: function (a, b, d, g, z, f, h, t, l) {
          ...
          var w = function () {
            var a = p.element.style,
              b = {};
            K =
              ("undefined" === typeof A || "undefined" === typeof y || e) &&
              G(p.textStr) &&
              p.getBBox();
            ...
            T =
              E +
              Math.min(
                x.fontMetrics(a && a.fontSize, p).b,
                K ? K.height : Infinity
              );
            u &&
              (N ||
          ...
          k.xSetter = function (a) {
            k.x = a;
            O &&
              ((a -= O * ((A || K.width) + 2 * E)), (k["forceAnimate:x"] = !0));
            m = Math.round(a);
            k.attr("translateX", m);
          };
    ...
    function (c, e) {
      ...
      G(m.prototype, {
        htmlCss: function (c) {
          ...
          c &&
            ...
            ((c.whiteSpace = "nowrap"), (c.overflow = "hidden"));
            ...
            if ("SPAN" === r.tagName) {
              ...
              g !== this.cTT &&
                ...
                this.getSpanCorrection(
                  (!I(l) && this.textPxLength) || r.offsetWidth,
                  y,
                  k,
                  l,
                  h
        ...
        setSpanRotation: function (c, r, f) {
          ...
          b[a + (B ? "Origin" : "-origin")] = b.transformOrigin =
            100 * r + "% " + f + "px";
          C(this.element, b);
        },
      ...
      G(e.prototype, {
        ...
        html: function (c, r, f) {
          ...
          b.attr({ text: c, x: Math.round(r), y: Math.round(f) }).css({
            position: "absolute",
          });
          d.styledMode ||
            b.css({
                ...
                if (!g) {
                  ...
                  l.reverse().forEach(function (a) {
                    ...
                    G(a, {
                      ...
                      on: function () {
                        l[0].div &&
                          b.on.apply({ element: l[0].div }, arguments);
                        return a;
                      },
                      translateXSetter: d,
                      translateYSetter: d,
      ...
      c.Time.prototype = {
        ...
        makeTime: function (m, r, e, A, f, b) {
          if (this.useUTC) {
            ...
            d !== h
              ? (a += h - d)
              : d - 36e5 !== this.getTimezoneOffset(a - 36e5) ||
                c.isSafari ||
                (a -= 36e5);
          } else
            a = new this.Date(
        ...
        dateFormat: function (m, r, e) {
          ...
          H(f, function (a, b) {
            for (; -1 !== m.indexOf("%" + b); )
              m = m.replace(
                "%" + b,
                "function" === typeof a ? a.call(A, r) : a
              );
          });
        ...
        resolveDTLFormat: function (c) {
          return G(c, !0)
            ? c
            : ((c = C(c)), { main: c[0], from: c[1], to: c[2] });
        },
        getTimeTicks: function (c, r, e, A) {
          ...
          if (F(r)) {
            f.set(
              "Milliseconds",
              d,
              h >= u.second ? 0 : k * Math.floor(f.get("Milliseconds", d) / k)
            );
            h >= u.second &&
              f.set(
                "Seconds",
                d,
                h >= u.minute ? 0 : k * Math.floor(f.get("Seconds", d) / k)
              );
            h >= u.minute &&
              f.set(
                "Minutes",
                d,
                h >= u.hour ? 0 : k * Math.floor(f.get("Minutes", d) / k)
              );
            h >= u.hour &&
              f.set(
                "Hours",
                d,
                h >= u.day ? 0 : k * Math.floor(f.get("Hours", d) / k)
              );
            h >= u.day &&
              f.set(
                "Date",
                ...
                h >= u.month
                  ? 1
                  : Math.max(1, k * Math.floor(f.get("Date", d) / k))
              );
            if (h >= u.month) {
              f.set(
                "Month",
                d,
                h >= u.year ? 0 : k * Math.floor(f.get("Month", d) / k)
              );
            ...
            h === u.week &&
              ((y = f.get("Day", d)),
              f.set("Date", d, f.get("Date", d) - y + A + (y < A ? -7 : 0)));
            y = f.get("FullYear", d);
            A = f.get("Month", d);
            var p = f.get("Date", d),
              g = f.get("Hours", d);
            ...
            f.variableTimezone &&
              (l =
                e - r > 4 * u.month ||
                f.getTimezoneOffset(r) !== f.getTimezoneOffset(e));
            r = d.getTime();
            for (d = 1; r < e; )
              b.push(r),
                (r =
  ...
  M(J, "parts/Options.js", [J["parts/Globals.js"]], function (c) {
    ...
    c.setOptions = function (e) {
      ...
      (e.time || e.global) &&
        c.time.update(
          F(c.defaultOptions.global, c.defaultOptions.time, e.global, e.time)
        );
      ...
      c.Tick.prototype = {
        addLabel: function () {
          ...
          if (e.isDatetimeAxis && k) {
            var x = f.time.resolveDTLFormat(
              m.dateTimeLabelFormats[
                (!m.grid && k.higherRanks[d]) || k.unitName
              ]
            );
            var L = x.main;
          }
                ...
                if (
                  (p.attr({
                    text: e.labelFormatter.call(
                      v(c.formatCtx, { dateTimeLabelFormat: t[g] })
                    ),
                  }),
          ...
          G(p) || c.movedLabel
            ...
            : ((c.label = p = c.createLabel({ x: 0, y: 0 }, m, h)),
              (c.rotation = 0));
        },
        ...
        createLabel: function (c, e, m) {
          ...
          if (
            (c =
              G(e) && m.enabled
                ? b.renderer.text(e, c.x, c.y, m.useHTML).add(f.labelGroup)
                : null)
          )
            b.styledMode || c.css(w(m.style)),
        ...
        handleOverflow: function (c) {
          ...
          a = B(
            e.labelRight,
            Math.max(e.isRadial ? 0 : e.pos + e.len, b - a[1])
          );
          var h = this.label,
            k = this.rotation,
            l = { left: 0, center: 0.5, right: 1 }[
          ...
          c = {
            x: c
              ...
              : b.left +
                b.offset +
                (b.opposite
                  ? ((f && a.oldChartWidth) || a.chartWidth) - b.right - b.left
                  : 0),
            y: c
          ...
          G(t) ||
            (t =
              0 === k.side
                ...
                : 2 === k.side
                ? g.y + 8
                : Math.cos(A.rotation * m) *
                  (g.y - A.getBBox(!1, 0).height / 2));
        ...
        renderGridLine: function (c, e, m) {
          ...
          a ||
            (f.chart.styledMode ||
              ((d.stroke = t), (d["stroke-width"] = g), b && (d.dashstyle = b)),
            k || (d.zIndex = 1),
            c && (e = 0),
            (this.gridLine = a =
              r
        ...
        renderLabel: function (c, e, m, f) {
          ...
          h &&
            ...
            y && q(c.y)
              ? ((c.opacity = m),
                h[this.isNewLabel ? "attr" : "animate"](c),
                (this.isNewLabel = !1))
    ...
    function (c, e) {
      ...
      B(e.prototype, {
        ...
        init: function (b, d) {
          ...
          g.side =
            d.side || (g.horiz ? (g.opposite ? 0 : 2) : g.opposite ? 1 : 3);
          g.setOptions(d);
          var z = this.options,
            h = z.type;
          ...
          g.crosshair = D(
            z.crosshair,
            f(b.options.tooltip.crosshairs)[n ? 0 : 1],
            !1
          );
          d = g.options.events;
          -1 === b.axes.indexOf(g) &&
            (n ? b.axes.splice(b.xAxis.length, 0, g) : b.axes.push(g),
            b[g.coll].push(g));
          g.series = g.series || [];
          b.inverted &&
            !g.isZAxis &&
            n &&
            "undefined" === typeof g.reversed &&
            (g.reversed = !0);
          r(d, function (b, d) {
            ...
            for (; l-- && "undefined" === typeof e; )
              (d = Math.pow(c, l + 1)),
                a >= d &&
                  ...
                  (e = p(b / d, -1) + t[l]);
          "undefined" === typeof e &&
            (e = 1e4 <= Math.abs(b) ? p(b, -1) : p(b, -1, void 0, ""));
          return e;
        },
        ...
        getPlotLinePath: function (a) {
          ...
          l(this, "getPlotLinePath", a, function (a) {
            ...
            a.path =
              y && !x
                ? null
                : d.renderer.crispLine(["M", k, p, "L", e, E], t || 1);
          });
          return a.path;
        },
          ...
          if (t && t / g < a.len / 3)
            if (a.isLog)
              this.paddedTicks.forEach(function (b, d, n) {
                d &&
                  f.push.apply(f, a.getLogTickPositions(g, n[d - 1], n[d], !0));
              });
        ...
        adjustForMinRange: function () {
            ...
            (q(a.min) || q(a.max)
              ...
              : (this.series.forEach(function (a) {
                  ...
                  for (f = t = a.xIncrement ? 1 : c.length - 1; 0 < f; f--)
                    if (
                      ((h = c[f] - c[f - 1]), "undefined" === typeof g || h < g)
                    )
                      g = h;
                }),
          ...
          if (d - b < this.minRange) {
            ...
            k = [b - k, D(a.min, b - k)];
            l &&
              (k[2] = this.isLog ? this.log2lin(this.dataMin) : this.dataMin);
            b = I(k);
            d = [b + x, D(a.max, b + x)];
            l &&
              (d[2] = this.isLog ? this.log2lin(this.dataMax) : this.dataMax);
            d = G(d);
        ...
        nameToX: function (a) {
          ...
          "undefined" !== typeof n &&
            ((this.names[n] = a.name), (this.names.keys[a.name] = n));
          return n;
        },
          ...
          0 < b.length &&
            ...
            (this.series || []).forEach(function (b) {
              ...
              if (!b.points || b.isDirtyData)
                (a.max = Math.max(a.max, b.xData.length - 1)),
                  b.processData(),
                  b.generatePoints();
          ...
          r &&
            ...
            !q(A) && b.min < y && b.dataMin >= y
              ? (b.min = b.options.minRange
                  ? Math.min(y, b.max - b.minRange)
                  : y)
              : !q(u) &&
                b.max > y &&
                b.dataMax <= y &&
                (b.max = b.options.minRange
                  ? Math.max(y, b.min + b.minRange)
                  : y));
          b.tickInterval =
            b.min === b.max ||
          ...
          l(this, "zoom", a, function (a) {
            ...
            if (b !== this.min || n !== this.max)
              this.allowZoomOutside ||
                ...
                q(g) && (n < f && (n = f), n > h && (n = h))),
                (this.displayBtn =
                  "undefined" !== typeof b || "undefined" !== typeof n),
        ...
        setAxisSize: function () {
          var a = this.chart,
            ...
            f = (this.width = Math.round(
              A(D(b.width, a.plotWidth - d[3] + d[1]), a.plotWidth)
            )),
            h = (this.height = Math.round(
              A(D(b.height, a.plotHeight - d[0] + d[2]), a.plotHeight)
            )),
            c = (this.top = Math.round(
              A(D(b.top, a.plotTop + d[0]), a.plotHeight, a.plotTop)
            ));
          b = this.left = Math.round(
            A(D(b.left, a.plotLeft + d[3]), a.plotWidth, a.plotLeft)
          );
        ...
        unsquish: function () {
          ...
          b
            ? (p =
                ...
                (q(c)
                  ? [c]
                  : f < D(a.autoRotationLimit, 80) && a.autoRotation)) &&
        ...
        getSlotWidth: function (a) {
          ...
          return (
            ...
            (d &&
              2 > (g.step || 0) &&
              !g.rotation &&
              ((this.staggerLines || 1) * this.len) / f) ||
            (!d &&
              ((g.style && parseInt(g.style.width, 10)) ||
                (n && n - b.spacing[3]) ||
                0.33 * b.chartWidth))
          );
        },
        renderUnsquish: function () {
          ...
          d.forEach(function (a) {
            ...
            a &&
              a.label &&
              a.label.textPxLength > e &&
              (e = a.label.textPxLength);
          });
          this.maxLabelLength = e;
          if (this.autoRotation)
            e > l && e > k.h
              ? (x.rotation = this.labelRotation)
          ...
          x.rotation &&
            ((E = e > 0.5 * a.chartHeight ? 0.33 * a.chartHeight : e),
            p || (L = "ellipsis"));
          if (
            (this.labelAlign =
              f.align || this.autoLabelAlign(this.labelRotation))
          )
            x.align = this.labelAlign;
          d.forEach(function (a) {
            var b = (a = g[a]) && a.label,
              d = h.width,
              f = {};
            b &&
              ...
              a.shortenLabel
                ...
                ? ((f.width = E),
                  p || (f.textOverflow = b.specificTextOverflow || L),
                  b.css(f))
                : b.styles &&
                  b.styles.width &&
                  !f.width &&
        ...
        getOffset: function () {
          ...
          a.axisGroup ||
            ...
            (a.axisGroup = d
              ...
              .addClass(
                "highcharts-" + this.coll.toLowerCase() + " " + (u || "")
              )
              .add(v)),
            (a.labelGroup = d
              .g("axis-labels")
          ...
          if (
            ...
            E.text &&
            !1 !== E.enabled &&
            (a.addTitle(k), k && !1 !== E.reserveSpace)
          ) {
          ...
          a.getMaxLabelDimensions &&
            (a.maxLabelDimensions = a.getMaxLabelDimensions(h, f));
        ...
        renderTick: function (a, b) {
          ...
          if (!d || (a >= this.min && a <= this.max))
            g[a] || (g[a] = new E(this, a)),
              f && g[a].isNew && g[a].render(b, !0, -1),
              g[a].render(b);
        },
        render: function () {
          var a = this,
          ...
          if (a.hasData() || h)
            a.minorTickInterval &&
              ...
              t.length &&
                ...
                y &&
                  (0 === a.min || a.single) &&
                  (k[-1] || (k[-1] = new E(a, -1, null, !0)),
                  k[-1].render(-1))),
              L &&
                t.forEach(function (b, g) {
                  v =
                    "undefined" !== typeof t[g + 1] ? t[g + 1] + y : a.max - y;
                  0 === g % 2 &&
                    b < a.max &&
                    v <= a.max + (d.polar ? -y : y) &&
        ...
        destroy: function (a) {
          ...
          for (f in b.plotLinesAndBandsGroups)
            b.plotLinesAndBandsGroups[f] =
              b.plotLinesAndBandsGroups[f].destroy();
          r(b, function (a, d) {
              ...
              this.chart.styledMode ||
                (c
                  .attr({
                    stroke:
                      g.color ||
                      (f ? d("#ccd6eb").setOpacity(0.25).get() : "#cccccc"),
  ...
  M(J, "parts/DateTimeAxis.js", [J["parts/Globals.js"]], function (c) {
    ...
    e.prototype.normalizeTimeTickInterval = function (c, e) {
      ...
      for (
        ...
        (v = G[e[0]]),
        (B = e[1]),
        q[u + 1] && c <= (v * B[B.length - 1] + G[q[u + 1][0]]) / 2);
        u++
      );
  ...
  M(
    ...
    function (c, e) {
      ...
      e.prototype.getLogTickPositions = function (c, e, q, C) {
        ...
        if (0.5 <= c)
          (c = Math.round(c)), (w = this.getLinearTickPositions(c, e, q));
        else if (0.08 <= c) {
          u = Math.floor(e);
          var m, r;
          for (
          ...
          (e = this.lin2log(e)),
            ...
            (c = F(
              ...
              ((v.tickPixelInterval / (C ? 5 : 1)) * (q - e)) /
                ((C ? u / this.tickPositions.length : u) || 1)
            )),
            (c = G(c, null, I(c))),
      ...
      c.PlotLineOrBand.prototype = {
        render: function () {
          ...
          var E = {},
            ...
            z = k ? "bands" : "lines";
          r.isLog &&
            ((d = r.log2lin(d)), (a = r.log2lin(a)), (h = r.log2lin(h)));
          r.chart.styledMode ||
            (l
              ? ((g.stroke = t || "#999999"),
              ...
              : k &&
                ((g.fill = t || "#e6ebf5"),
                A.borderWidth &&
                  ((g.stroke = A.borderColor),
                  (g["stroke-width"] = A.borderWidth))));
          E.zIndex = x;
          z += "-" + x;
          ...
          (p || !y.d) && g && g.length
            ...
            : y &&
              (g
                ? (y.show(!0), y.animate({ d: g }))
                : y.d && (y.hide(), b && (e.label = b = b.destroy())));
          f &&
          (H(f.text) || H(f.formatter)) &&
          g &&
          g.length &&
          0 < r.width &&
          0 < r.height &&
      ...
      c.Tooltip.prototype = {
        ...
        getLabel: function () {
          ...
          if (!this.label) {
            this.outside &&
              ...
              (this.renderer = f =
                new c.Renderer(h, 0, 0, {}, void 0, void 0, f.styledMode)));
            this.split
              ? (this.label = f.g(d))
              : ((this.label = f
                  .label(
        ...
        move: function (e, f, b, a) {
          var d = this,
            ...
            k =
              ...
              !d.isHidden &&
              (1 < Math.abs(e - h.x) || 1 < Math.abs(f - h.y)),
        ...
        getPosition: function (c, f, b) {
          var a = this.chart,
              ...
              return [h, n ? p : g, n ? c : f].concat(
                e
                  ? [
                      n ? L(c) : E(f),
                      n
                        ? t.left - d + L(b.plotX + a.plotLeft)
                        : t.top - d + E(b.plotY + a.plotTop),
                      0,
                      n ? p : g,
                    ]
                  : [
            ...
            m = n("x"),
            r =
              !this.followPointer && C(b.ttBelow, !a.inverted === !!b.negative),
              ...
              : (this.split
                  ...
                  : ((e = this.getLabel()),
                    ...
                    e
                      ...
                      .addClass(
                        "highcharts-color-" + C(d.colorIndex, l.colorIndex)
                      ),
                    y ||
                      e.attr({
                        stroke:
                          a.borderColor || d.color || l.color || "#666666",
                      }),
                    this.updatePosition({
                      plotX: f,
                      plotY: g,
        ...
        renderSplit: function (e, f) {
          ...
          e = e.slice(0, f.length + 1).reduce(function (d, c, h) {
            if (!1 !== c && "" !== c) {
              ...
              var e = h.series;
              var k =
                "highcharts-color-" + C(h.colorIndex, e.colorIndex, "none");
              l ||
                ((l = { padding: w.padding, r: w.borderRadius }),
                u ||
                  ((l.fill = w.backgroundColor),
                  (l["stroke-width"] = w.borderWidth)),
                (l = L.label(
                  null,
                  null,
                  null,
        ...
        getDateFormat: function (c, f, b, a) {
          ...
          for (y in D) {
            ...
            if (e[y] && h.substr(e[y]) !== "01-01 00:00:00.000".substr(e[y]))
              break;
            "week" !== y && (l = y);
          }
        ...
        getXDateFormat: function (c, f, b) {
          ...
          return (
            (a
              ? this.getDateFormat(a, c.x, b.options.startOfWeek, f)
              : f.day) || f.year
          );
        },
      ...
      c.Pointer.prototype = {
        init: function (a, d) {
          ...
          b &&
            ...
            (this.followTouchMove = B(d.tooltip.followTouchMove, !0)));
          this.setDOMEvents();
        },
        ...
        normalize: function (a, b) {
          ...
          b = d.pageY - b.top;
          if ((d = this.chart.containerScaling))
            (c /= d.scaleX), (b /= d.scaleY);
            ...
            (e && !b.noSharedTooltip
              ? ((h = c.filter(function (a) {
                ...
                h.forEach(function (a) {
                  ...
                  v(b) &&
                    (a.chart.isBoosting && (b = a.getPoint(b)), g.push(b));
                }))
              : g.push(d));
        ...
        runPointActions: function (a, b) {
          ...
          p = this.getHoverData(
            ...
            d.series,
            (!a || "touchmove" !== a.type) &&
              (!!b || (p && p.directTouch && this.isDirectTouch)),
            e,
            a
          );
          y = p.hoverPoint;
          ...
          if (y && (y !== d.hoverPoint || (f && f.isHidden))) {
            ...
            b &&
              ...
              !f.isHidden &&
              ((y = f.getAnchor([{}], a)),
              f.updatePosition({ plotX: y[0], plotY: y[1] }));
          this.unDocMouseMove ||
            (this.unDocMouseMove = w(
        ...
        scaleGroups: function (a, b) {
          ...
          d.series.forEach(function (f) {
            ...
            f.xAxis &&
              ...
              (f.group.attr(c),
              f.markerGroup &&
                (f.markerGroup.attr(c),
                f.markerGroup.clip(b ? d.clipRect : null)),
                ...
                b.styledMode ||
                  E.attr({
                    fill:
                      ...
                      r("#335cad").setOpacity(0.25).get(),
                  }));
              E &&
                m &&
                ((f -= n),
                E.attr({ width: Math.abs(f), x: (0 < f ? 0 : f) + n }));
              E &&
                p &&
                ((f = e - z),
                E.attr({ height: Math.abs(f), y: (0 < f ? 0 : f) + z }));
            ...
            if (this.hasDragged || e)
              c.axes.forEach(function (d) {
                if (
                  d.zoomEnabled &&
                  I(d.min) &&
                  (e || b[{ xAxis: "zoomX", yAxis: "zoomY" }[d.coll]])
                ) {
                  var c = d.horiz,
        ...
        onContainerMouseMove: function (a) {
          ...
          (I(c.hoverChartIndex) &&
            m[c.hoverChartIndex] &&
            m[c.hoverChartIndex].mouseIsDown) ||
        ...
        onContainerClick: function (a) {
          ...
          b.cancelClick ||
            (c && this.inClass(a.target, "highcharts-tracker")
              ? (f(c.series, "click", G(a, { point: c })),
                b.hoverPoint && c.firePointEvent("click", a))
              : (G(a, this.getCoordinates(a)),
                b.isInsidePlot(a.chartX - e, a.chartY - l) &&
                  f(b, "click", a)));
        },
        setDOMEvents: function () {
          ...
          this.unbindContainerMouseLeave = w(
            b,
            "mouseleave",
            a.onContainerMouseLeave
          );
          c.unbindDocumentMouseUp ||
            (c.unbindDocumentMouseUp = w(f, "mouseup", a.onDocumentMouseUp));
          c.hasTouch &&
    ...
    function (c, e) {
      ...
      F(c.Pointer.prototype, {
        ...
        pinchTranslateDirection: function (c, e, C, B, u, w, m, r) {
          ...
          n
            ? ((x -= 0.8 * (x - m[v][0])), g || (E -= 0.8 * (E - m[v][1])), C())
            : (m[v] = [x, E]);
          y || ((w[v] = k - d), (w[a] = h));
          w = y ? 1 / l : l;
          u[a] = h;
        ...
        pinch: function (c) {
          var e = this,
            ...
            f =
              1 === w &&
              ((e.inClass(c.target, "highcharts-tracker") &&
                v.runTrackerClick) ||
                e.runChartClick),
            b = {};
          1 < w && (e.initiated = !0);
              ...
              v.axes.forEach(function (a) {
                if (a.zoomEnabled) {
                  var b = v.bounds[a.horiz ? "h" : "v"],
                    c = a.minPixelPadding,
                    f = a.toPixels(
                      Math.min(I(a.options.min, a.dataMin), a.dataMin)
                    ),
                    e = a.toPixels(
                      Math.max(I(a.options.max, a.dataMax), a.dataMax)
                    ),
                    m = Math.max(f, e);
            ...
            if (
              ...
              if ("touchmove" === e.type) {
                ...
                var u = q[0]
                  ? 4 <=
                    Math.sqrt(
                      Math.pow(q[0].chartX - e.chartX, 2) +
                        Math.pow(q[0].chartY - e.chartY, 2)
                    )
                  : !1;
              }
              I(u, !0) && this.pinch(e);
    ...
    function (c, e) {
      ...
      if (!c.hasTouch && (w.PointerEvent || w.MSPointerEvent)) {
        var m = {},
          ...
          A = function (f, b, a, d) {
            ("touch" !== f.pointerType &&
              f.pointerType !== f.MSPOINTER_TYPE_TOUCH) ||
              !H[c.hoverChartIndex] ||
              (d(f),
        ...
        F(B.prototype, {
          ...
          onContainerPointerMove: function (c) {
            A(c, "onContainerTouchMove", "touchmove", function (b) {
              ...
              m[b.pointerId].target ||
                (m[b.pointerId].target = b.currentTarget);
            });
          },
    ...
    function (c, e) {
      ...
      c.Legend.prototype = {
        ...
        colorizeItem: function (b, a) {
          ...
          if (!this.chart.styledMode) {
            ...
            e &&
              (g &&
                e.isMarker &&
                ((t = b.pointAttribs()), a || (t.stroke = t.fill = m)),
              e.attr(t));
          }
        ...
        setText: function (b) {
          ...
          b.legendItem.attr({
            text: a.labelFormat
              ? c.format(a.labelFormat, b, this.chart)
        ...
        renderItem: function (b) {
          ...
          x ||
            ...
            (b.legendItem = x =
              d.text("", t ? f + e : -e, this.baseline || 0, z)),
          ...
          (!a.styledMode && m.width) ||
            x.css({
              width:
                (c.itemWidth || this.widthOption || a.spacingBox.width) - g,
            });
          this.setText(b);
          a = x.getBBox();
          b.itemWidth = b.checkboxOffset =
            c.itemWidth || b.legendItemWidth || a.width + g;
        ...
        layoutItem: function (b) {
          ...
          a =
            a.alignColumns && this.totalItemWidth > g
              ? this.maxItemWidth
              : b.itemWidth;
          c &&
            this.itemX - d + a > g &&
          ...
          c
            ? (this.itemX += a)
            : ((this.itemY += m + f + e), (this.lastLineHeight = f));
          this.offsetWidth =
            this.widthOption ||
            Math.max(
        ...
        proximatePositions: function () {
          ...
          this.allItems.forEach(function (f) {
            ...
            if (f.yAxis && f.points) {
              ...
              var h = c.find(
                e ? f.points : f.points.slice(0).reverse(),
                function (a) {
                  return G(a.plotY);
                }
              );
              ...
              f.visible
                ? ((h = h ? h.plotY : f.yAxis.height), (h += m - 0.3 * e))
                : (h = m + f.yAxis.height);
        ...
        handleOverflow: function (b) {
          ...
          b > e && !1 !== x.enabled
            ? ((this.clipHeight = g =
              ...
              t ||
                ((t = a.clipRect = c.clipRect(0, m, 9999, 0)),
    ...
    function (c, e) {
      ...
      q(Q.prototype, {
        ...
        isInsidePlot: function (a, b, d) {
          ...
          a = d ? a : b;
          return (
            0 <= g && g <= this.plotWidth && 0 <= a && a <= this.plotHeight
          );
        },
        redraw: function (a) {
          E(this, "beforeRedraw");
        ...
        getSelectedPoints: function () {
          ...
          this.series.forEach(function (b) {
            a = a.concat(
              (b[b.hasGroupedData ? "points" : "data"] || []).filter(function (
                a
              ) {
          ...
          if (a)
            for (; b && b.style; )
              b.hcOrigStyle && (c.css(b, b.hcOrigStyle), delete b.hcOrigStyle),
                b.hcOrigDetached &&
                  (l.body.removeChild(b), (b.hcOrigDetached = !1)),
                (b = b.parentNode);
          else
            for (; b && b.style; ) {
              l.body.contains(b) ||
                b.parentNode ||
                ((b.hcOrigDetached = !0), l.body.appendChild(b));
        ...
        setChartSize: function (a) {
          ...
          this.plotWidth = x = Math.max(
            0,
            Math.round(g - t - this.marginRight)
          );
          this.plotHeight = l = Math.max(
            0,
            Math.round(c - n - this.marginBottom)
          );
          ...
          this.clipBox = {
            ...
            height: Math.max(
              0,
              Math.floor(this.plotSizeY - Math.max(g, h[2]) / 2 - d)
            ),
          };
          a ||
        ...
        drawChartBox: function () {
          ...
          if (h) var u = (p = c.strokeWidth());
            ...
            n = { fill: n || "none" };
            if (u || c["stroke-width"])
              (n.stroke = a.borderColor), (n["stroke-width"] = u);
  ...
  M(
    ...
    function (c, e) {
      ...
      I(e, "afterSetChartSize", function (e) {
        ...
        if (!this.renderer.forExport) {
          if (v) {
            ...
            G &&
              (this.scrollablePixelsY = v =
                Math.max(0, G - this.chartHeight)) &&
              ((this.plotHeight += v),
              this.inverted
                ? ((this.clipBox.width += v), (this.plotBox.width += v))
                : ((this.clipBox.height += v), (this.plotBox.height += v)),
            ...
            this.axes.forEach(function (e) {
              q[e.side]
                ? (e.getPlotLinePath = function () {
                    ...
                    var w = c.Axis.prototype.getPlotLinePath.apply(
                      this,
                      arguments
                    );
                    this[v] = u;
      ...
      e.prototype.setUpScrolling = function () {
        ...
        this.scrollingContainer = c.createElement(
          "div",
        ...
        H
          ? ((this.fixedDiv = c.createElement(
            ...
            (this.fixedRenderer = e =
              new c.Renderer(this.fixedDiv, this.chartWidth, this.chartHeight)),
      ...
      c.Point.prototype = {
        ...
        applyOptions: function (c, b) {
          ...
          "undefined" === typeof this.x &&
            a &&
            (this.x = "undefined" === typeof b ? a.autoIncrement(this) : b);
          return this;
        },
        ...
        optionsToObject: function (f) {
          ...
          if (q(f) || null === f) b[e[0]] = f;
            ...
            for (
              ...
              f.length > k &&
              ((a = typeof f[0]),
              "string" === a ? (b.name = f[0]) : "number" === a && (b.x = f[0]),
              l++);
              m < k;
            ...
            "object" === typeof f &&
              ((b = f),
              f.dataLabels && (a._hasPointLabels = !0),
              f.marker && (a._hasPointMarkers = !0));
          return b;
        },
        ...
        destroy: function () {
          ...
          var e = d.hoverPoints,
            ...
            l;
          a && a.enabled
            ? (this.animateBeforeDestroy(), B(c, k.duration))
            : c();
          d.pointCount--;
        ...
        animateBeforeDestroy: function () {
          ...
          d.singular.forEach(function (d) {
            a = "dataLabel" === d;
            c[d] = c[d].animate(
              a ? { x: c[d].startXPos, y: c[d].startYPos, opacity: 0 } : b
            );
          });
        ...
        firePointEvent: function (c, b, a) {
          ...
          (f.point.events[c] ||
            (d.options && d.options.events && d.options.events[c])) &&
            this.importEvents();
          "click" === c &&
            f.allowPointSelect &&
            (a = function (a) {
        ...
        },
        {
          ...
          autoIncrement: function () {
            ...
            c &&
              ...
              "day" === c
                ...
                : "year" === c &&
                  f.set("FullYear", a, f.get("FullYear", a) + d),
              (d = a.getTime() - b));
            this.xIncrement = b + d;
            return b;
          },
          ...
          setOptions: function (b) {
            ...
            (!f.negativeColor && !f.negativeFillColor) ||
              ...
              d ||
                ((g.color = f.negativeColor),
                (g.fillColor = f.negativeFillColor)),
              c.push(g));
            c.length &&
          ...
          getCyclic: function (a, b, d) {
            var c = this.chart,
              ...
              h = d
                ? d.length
                : D(c.options.chart[a + "Count"], c[a + "Count"]);
            if (!b) {
              var t = D(g[f], g["_" + f]);
              q(t) ||
                (c.series.length || (c[e] = 0),
                (g["_" + f] = t = c[e] % h),
                (c[e] += 1));
              d && (b = d[t]);
            }
          ...
          getColor: function () {
            this.chart.styledMode
              ...
              : this.getCyclic(
                  "color",
                  this.options.color || d[this.type].color,
          ...
          processData: function (a) {
            ...
            if (m && !this.isDirty && !e.isDirty && !this.yAxis.isDirty && !a)
              return !1;
            if (e) {
              a = e.getExtremes();
              var q = a.min;
            ...
            for (q = 0; q < p; q++) {
              ...
              if (k) {
                ...
                u.dataGroup.options &&
                  ...
                  B(u, u.dataGroup.options),
                  delete u.dataLabels);
              } else
                (u = d[y]) ||
                  "undefined" === typeof b[y] ||
                  (d[y] = u = new l().init(this, b[y], f[q]));
              u && ((u.index = y), (r[q] = u));
            }
            this.options.keys = a;
            if (d && (p !== (c = d.length) || k))
            ...
            for (m = 0; m < p; m++) {
              ...
              var M = F.low,
                Z =
                  b &&
                  e.stacks[
                    (this.negStacks && W < (B ? 0 : A) ? "-" : "") +
                      this.stackKey
                  ];
              e.positiveValuesOnly && null !== W && 0 >= W && (F.isNull = !0);
              F.plotX = C = v(
                H(
                  d.translate(J, 0, 0, 0, 1, r, "flags" === this.type),
                  -1e5,
                  1e5
                )
              );
              ...
              F.yBottom = q(M)
                ? H(e.translate(M, 0, 1, 0, 1), -1e5, 1e5)
                : null;
              k && (W = this.modifyValue(W, F));
              F.plotY = W =
                "number" === typeof W && Infinity !== W
                  ? H(e.translate(W, 0, 1, 0, 1), -1e5, 1e5)
                  : void 0;
              F.isInside =
                "undefined" !== typeof W &&
                0 <= W &&
          ...
          setClip: function (a) {
            ...
            if (!1 !== d.clip || a)
              this.group.clip(a || f ? l : b.clipRect),
              ...
              for (d = 0; d < a.length; d++) {
                ...
                if (
                  ...
                  this.enabledDataSorting &&
                    (p.startXPos = h.reversed ? -y.width : h.width);
                  var u = !1 !== p.isInside;
                  c
                    ...
                    : u &&
                      ...
                      ((p.graphic = c =
                        b.renderer
                          .symbol(q, y.x, y.y, y.width, y.height, r ? k : f)
                          .add(e)),
                      this.enabledDataSorting &&
                        b.hasRendered &&
                  ...
                  if (c && !b.styledMode)
                    c[m](this.pointAttribs(p, p.selected && "select"));
          ...
          pointAttribs: function (a, b) {
            ...
            c = D(
              b.lineWidth,
              d.lineWidth,
              c + D(b.lineWidthPlus, d.lineWidthPlus, 0)
            );
          ...
          drawGraph: function () {
            ...
            f.forEach(function (f, g) {
              var e = f[0],
                ...
                l = h ? "animate" : "attr";
              h
                ? ((h.endX = a.preventGraphAnimation ? null : d.xMap),
                  h.animate({ d: d }))
                : d.length &&
                  (a[e] = h =
                    a.chart.renderer
          ...
          applyZones: function () {
            ...
            if (c.length && (p || k) && r && "undefined" !== typeof r.min) {
              ...
              c.forEach(function (c, g) {
                ...
                w = Math.max(f, e);
                r.isXAxis
                  ? ((l = { x: q ? w : u, y: 0, width: y, height: m }),
                    C || (l.x = b.plotHeight - l.x))
                  : ((l = { x: 0, y: q ? w : u, width: m, height: y }),
          ...
          invertGroups: function (a) {
            ...
            var c = this,
              f = c.chart;
            c.xAxis &&
              (c.eventsToUnbind.push(b(f, "resize", d)),
              d(),
              (c.invertGroups = d));
          },
          plotGroup: function (a, b, d, c, f) {
            ...
            g.attr({ visibility: d })[e ? "attr" : "animate"](
              this.getPlotBox()
            );
            return g;
          },
    ...
    function (c, e) {
      ...
      c.StackItem = function (c, e, m, r, q) {
        ...
        this.alignOptions = {
          ...
          verticalAlign:
            e.verticalAlign || (u ? "middle" : m ? "bottom" : "top"),
          y: e.y,
          x: e.x,
        };
      ...
      c.StackItem.prototype = {
        ...
        setOffset: function (c, e, m, r, q) {
          var u = this.axis,
            f = u.chart;
          r = u.translate(
            u.usePercentage ? 100 : r ? r : this.total,
            0,
            0,
            0,
            1
    ...
    function (c, e) {
      ...
      c.cleanRecursively = function (a, b) {
        ...
        B(a, function (f, g) {
          if (q(a[g], !0) && !a.nodeType && b[g])
            (f = c.cleanRecursively(a[g], b[g])),
              Object.keys(f).length && (d[g] = f);
      ...
      G(e.prototype, {
        ...
        update: function (a, b, f, e) {
          ...
          if ((p = a.chart)) {
            ...
            "alignTicks" in p && (x = !0);
            B(p, function (a, b) {
              -1 !== g.propsRequireUpdateSeries.indexOf("chart." + b) &&
                (k = !0);
      ...
      G(k.prototype, {
        update: function (a, b, d, c) {
          function f() {
            ...
            k.data[l] =
              q(k.data[l], !0) || q(a, !0) ? g.options : u(a, k.data[l]);
      ...
      G(l.prototype, {
        ...
        update: function (a, b) {
          ...
          y[p || l]
            ? G(f, y[p || l].prototype)
            : c.error(17, !0, g, { missingModuleFor: p || l });
          v.forEach(function (a) {
            f[a] = v[a];
          });
          f.init(g, a);
      ...
      G(f.prototype, {
        ...
        remove: function (a) {
          for (
            var b = this.chart, d = this.coll, c = this.series, f = c.length;
            f--;
          ...
          getGraphPath: function (c) {
            ...
            for (w = 0; w < c.length; w++) {
              ...
              if (!d || v)
                v || a(w, w - 1, "left"),
                  (d && !B && v) ||
                    (r.push(c[w]), m.push({ x: w, plotX: h, plotY: k })),
                  v || a(w, w + 1, "right");
            }
            w = e.call(this, r, !0, !0);
            m.reversed = !0;
          ...
          drawGraph: function () {
            ...
            B.forEach(function (q) {
              var v = q[0],
                ...
                u = {};
              m
                ? ((m.endX = c.preventGraphAnimation ? null : e.xMap),
                  m.animate({ d: e }))
                : ((u.zIndex = 0),
                  (m = c[v] =
                    c.chart.renderer.path(e).addClass(q[1]).add(c.group)),
                  (m.isArea = !0));
              c.chart.styledMode ||
                (u.fill = I(
                  q[3],
                  G(q[2]).setOpacity(I(C.fillOpacity, 0.75)).get()
                ));
              m[r](u);
              m.startX = e.xMap;
      ...
      c(
        ...
        {},
        {
          getPointSpline: function (c, e, H) {
            ...
            e = [
              "C",
              F(C.rightContX, C.plotX),
              F(C.rightContY, C.plotY),
              F(w, v),
              F(m, q),
              v,
              q,
        ...
        },
        {
          ...
          getColumnMetrics: function () {
            ...
            var h = Math.min(
              ...
              l = (h - 2 * k) / (d || 1);
            e = Math.min(
              e.maxPointWidth || v.len,
              q(e.pointWidth, l * (1 - 2 * e.pointPadding))
            );
            c.columnMetrics = {
              width: e,
              offset:
                (l - e) / 2 +
                (k + ((c.columnIndex || 0) + (f ? 1 : 0)) * l - h / 2) *
                  (f ? -1 : 1),
            };
          ...
          crispCol: function (c, e, q, v) {
            ...
            this.options.crisp &&
              ((q = Math.round(c + q) + a), (c = Math.round(c) + a), (q -= c));
            v = Math.round(e + v) + b;
          ...
          translate: function () {
            ...
            c.points.forEach(function (h) {
              ...
              h.shapeArgs = c.crispCol.apply(
                c,
                h.isNull ? [n, a, z, 0] : [n, v, z, u]
              );
            });
          },
          getSymbol: c.noop,
          ...
          pointAttribs: function (c, e) {
            ...
            e &&
              ...
              ((c = B(
                m.states[e],
                (c.options.states && c.options.states[e]) || {}
              )),
              (e = c.brightness),
              (a =
                c.color ||
                ("undefined" !== typeof e &&
                  C(a).brighten(c.brightness).get()) ||
                a),
              (d = c[f] || d),
              (h = c[b] || h),
              (r = c.dashStyle || r),
          ...
          drawPoints: function () {
            ...
            c.points.forEach(function (a) {
              ...
              if (v(a.plotY) && null !== a.y) {
                ...
                d ||
                  ((a.graphic = d =
                    u[a.shapeType](b).add(a.group || c.group)) &&
                    c.enabledDataSorting &&
                    e.hasRendered &&
                    e.pointCount < f &&
            ...
            c.points.forEach(function (f) {
              ...
              if (!f.isNull && e) {
                ...
                if (!b.styledMode) {
                  ...
                  m &&
                    !h &&
                    (h = f.shadowGroup = a.g("shadow").add(c.shadowGroup));
                  h && h.attr(d);
          ...
          setVisible: function (c, b) {
            ...
            c !== a.visible &&
              ((a.visible =
                a.options.visible =
                c =
                  "undefined" === typeof c ? !a.visible : c),
            ...
            crookedLine: function (c, b, a) {
              ...
              a =
                "left" === d
                  ...
                  : l + (e - m) * a;
              e = ["L", a, c.y];
              if ("left" === d ? a > c.x || a < b.x : a < c.x || a > b.x)
                e = [];
  ...
  M(
    ...
    function (c, e) {
      ...
      c.distribute = function (b, a, d) {
        ...
        for (
          ...
          for (k = b.length; k--; )
            (l = b[k]),
              (g =
                (Math.min.apply(0, l.targets) + Math.max.apply(0, l.targets)) /
                2),
          ...
          for (l = !1; k--; )
            0 < k &&
              ...
              (b[k - 1].align = 0.5),
              b[k - 1].pos + b[k - 1].size > a &&
                (b[k - 1].pos = a - b[k - 1].size),
              b.splice(k, 1),
              (l = !0));
        }
        m.push.apply(m, p);
      ...
      D.prototype.drawDataLabels = function () {
        ...
        function a(a, b) {
          ...
          if (q(a) && !q(b))
            ...
            for (c = Math.max(a.length, b.length); c--; ) d[c] = r(a[c], b[c]);
          else d = r(a, b);
          return d;
        }
        var d = this,
        ...
        l = a(
          a(
            ...
            e.options.plotOptions &&
              e.options.plotOptions[d.type] &&
              e.options.plotOptions[d.type].dataLabels
          ),
          l
        );
          ...
          y.forEach(function (c) {
            ...
            p.forEach(function (a, g) {
              ...
              if (h) {
                ...
                q = H(r)
                  ? m(r, q, e)
                  : (a[c.formatPrefix + "Formatter"] || a.formatter).call(q, a);
                r = a.style;
                var y = a.rotation;
                e.styledMode ||
              ...
              !l || (h && H(q))
                ? h &&
                  ...
                  a.textPath &&
                    !a.useHTML &&
                    (l.setTextPath(
                      (c.getDataLabelPath && c.getDataLabelPath(l)) ||
                        c.graphic,
                      a.textPath
                    ),
                    c.dataLabelPath &&
      ...
      D.prototype.alignDataLabel = function (b, a, c, e, f) {
        ...
        if (A) {
          var D = h.renderer.fontMetrics(
            h.styledMode ? void 0 : c.style.fontSize,
            a
          ).b;
          e = v(
            {
          ...
          w && 0 <= e.height
            ...
            : B(c.crop, !0) &&
              (A =
                h.isInsidePlot(k.x, k.y) &&
                h.isInsidePlot(k.x + q.width, k.y + q.height));
          if (c.shape && !r)
            a[f ? "attr" : "animate"]({
      ...
      D.prototype.setDataLabelStartPos = function (b, a, c, e, f) {
        ...
        d.hasRendered &&
          (c && a.attr({ x: a.startXPos, y: a.startYPos }), (a.placed = !0));
      };
                ...
                for (S = 0; S < k; S++) {
                  ...
                  m &&
                    ...
                    ("undefined" === typeof d.distributeBox.pos
                      ? (M = "hidden")
                      : ((F = d.distributeBox.size),
                        (K = X.radialDistributionY(d))));
                  ...
                  w._pos = {
                    x: J + f.x + ({ left: l, right: -l }[C.alignment] || 0),
                    y: K + f.y - 10,
                  };
                  C.final.x = J;
                  C.final.y = K;
                  B(f.crop, !0) &&
                    ...
                    J - A < l && 1 === h
                      ...
                      : J + A > p - l &&
                        0 === h &&
                        ((t = Math.round(J + A - p + l)),
                        (U[1] = Math.max(t, U[1]))),
                    0 > K - F / 2
                      ? (U[0] = Math.max(Math.round(-K + F / 2), U[0]))
                      : K + F / 2 > g &&
                        (U[2] = Math.max(Math.round(K + F / 2 - g), U[2])),
                    (w.sideOverflow = t));
                }
              }
            }),
        ...
        (A.pie.prototype.placeDataLabels = function () {
          this.points.forEach(function (b) {
            ...
            a &&
              ...
              ((c = a._pos)
                ? (a.sideOverflow &&
                    ((a._attr.width = Math.max(
                      a.getBBox().width - a.sideOverflow,
                      0
                    )),
                    a.css({
      ...
      A.column &&
        (A.column.prototype.alignDataLabel = function (b, a, c, e, f) {
          ...
          c.verticalAlign = B(
            c.verticalAlign,
            d || k ? "middle" : g ? "top" : "bottom"
          );
          D.prototype.alignDataLabel.call(this, b, a, c, e, f);
          e &&
            ((0 >= e.height && e.y === this.chart.plotHeight) ||
              (0 >= e.width && 0 === e.x)) &&
            (a.hide(!0), (a.placed = !1));
          ...
          a._hasTracking ||
            (a.trackerGroups.forEach(function (e) {
              if (a[e]) {
                ...
                !b.styledMode &&
                  a.options.cursor &&
                  a[e].css(u).css({ cursor: a.options.cursor });
              }
            }),
            (a._hasTracking = !0));
      ...
      I(e.prototype, {
        showResetZoom: function () {
          ...
          var b = this,
            ...
            f = e.states,
            h =
              "chart" === d.relativeTo || "spaceBox" === d.relativeTo
                ? null
                : "plotBox";
        ...
        zoom: function (a) {
          ...
          !a || a.resetSelection
            ...
            : a.xAxis.concat(a.yAxis).forEach(function (a) {
                ...
                d[p ? "zoomX" : "zoomY"] &&
                  k &&
                  ((c = g.zoom(a.min, a.max)), g.displayBtn && (e = !0));
              });
          var h = b.resetZoomButton;
          e && !h
            ? b.showResetZoom()
            : !e && H(h) && (b.resetZoomButton = h.destroy());
          c &&
            b.redraw(
              q(b.options.chart.animation, a && a.animation, 100 > b.pointCount)
            );
        },
        pan: function (a, b) {
          var c = this,
          ...
          r(this, "pan", { originalEvent: a }, function () {
            ...
            b.forEach(function (b) {
              ...
              var l = c[g],
                k = (d.pointRange || 0) / 2,
                p =
                  (d.reversed && !c.inverted) || (!d.reversed && c.inverted)
                    ? -1
                    : 1,
                m = d.getExtremes(),
              ...
              p = Math.min(
                m.dataMin,
                k ? m.min : d.toValue(d.toPixels(m.min) - d.minPixelPadding)
              );
              k = Math.max(
                m.dataMax,
                k ? m.max : d.toValue(d.toPixels(m.max) + d.minPixelPadding)
              );
              if (!e.ordinal) {
                b &&
                  ((e = p - l),
                ...
                if (
                  ...
                  (d.panningState &&
                    l >= d.panningState.startMin &&
                    n <= d.panningState.startMax)
                )
              ...
              b ||
                e.getSelectedPoints().forEach(function (a) {
                  ...
                  a.selected &&
                    ...
                    a.setState(
                      e.hoverPoints && b.options.inactiveOtherPoints
                        ? "inactive"
                        : ""
                    ),
            ...
            if (this.graphic) {
              ...
              if (!y.styledMode) {
                ...
                c.options.inactiveOtherPoints &&
                  ...
                  this.connector &&
                    this.connector.animate({ opacity: C.opacity }, D));
                this.graphic.animate(C, D);
              }
              A &&
                this.graphic.animate(
                  A,
                  q(y.options.chart.animation, l.animation, f.animation)
                );
              u && u.hide();
            } else {
              if (a && l) {
                  ...
                  if (u) u[b ? "animate" : "attr"]({ x: A.x, y: A.y });
                    ...
                    d &&
                      ((c.stateMarkerGraphic = u =
                        y.renderer
                          .symbol(d, A.x, A.y, A.width, A.height)
                          .add(c.markerGroup)),
                      (u.currentSymbol = d));
                !y.styledMode && u && u.attr(c.pointAttribs(this, a));
              }
              u &&
                (u[a && this.isInside ? "show" : "hide"](),
      ...
      I(a.prototype, {
        ...
        setState: function (a, b) {
          ...
          if (
            ...
            if (e && !e.dashstyle)
              for (
                h = { "stroke-width": l }, e.animate(h, m);
                c["zone-graph-" + d];
